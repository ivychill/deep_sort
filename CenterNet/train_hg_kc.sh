...
load_model='/usr/zll/person_reid/code/CenterNet/models/ctdet_coco_hg.pth'
...
python main.py ctdet --exp_id train_hg_kc --dataset kc_big --arch hourglass --batch_size 8 --lr 2.5e-5 \
